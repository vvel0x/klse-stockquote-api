...
async function getStockQuote(stSymbol) {
    const URI = 'https://klse.i3investor.com/quoteservlet.jsp?sa=ss&q=' + stSymbol
...
module.exports = async (stsym) => {
    const quote = await getStockQuote(stsym)
    return quote
}